...
1. Ingrese a `https://example.invalid/configure-google-service` con la cuenta que enviará los correos.
2. Cree un proyecto independiente, por ejemplo **Gestión de Boletas - Reportes**.
...
El correo saldrá desde la cuenta que despliegue el Web App. Para que el remitente sea `usuario@ejemplo.com`, el proyecto debe crearse y desplegarse desde esa cuenta o desde una cuenta que tenga configurado ese alias en Google Workspace.
...
TEMPLATE_BOLETA_ID=CONFIGURE_ME
