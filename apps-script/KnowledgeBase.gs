/**
 * Gestión de Boletas - MÓDULO DE BASE DE CONOCIMIENTOS
 *
...
function apiKnowledgeAttachmentUpload_(ctx) {
  ...
  file.setDescription('Adjunto de tutorial GT: ' + article.Titulo);
...
function getKnowledgeRootFolder_() {
  ...
  var folder = parent ? parent.createFolder('Base de conocimientos') : DriveApp.createFolder('GT - Base de conocimientos');
