/**
 * Compatibilidad para localizar la hoja de cálculo usada por Gestión de Boletas.
 *
...
function ss_() {
  ...
  throw new Error(
    'No se pudo localizar la hoja de datos de Gestión de Boletas. ' +
 ...
 * hoja de Gestión de Boletas. Guarda su ID para que el Web App pueda abrirla después.
 */
