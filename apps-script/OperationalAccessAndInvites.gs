/**
 * Gestión de Boletas - ACCESO OPERATIVO E INVITACIONES
 *
 * Este archivo agrega:
...
function sendNewUserCredentialsEmail_(user, temporaryPassword, createdByUserId) {
  ...
  var subject = 'Tu acceso temporal a Gestión de Boletas';
  var linkText = appUrl
  ...
  var plainBody = [
    'Hola ' + name + ',',
    '',
    'Se creó una cuenta para ti en Gestión de Boletas.',
    'Usuario: ' + username,
    ...
    '',
    'Empresa de Servicios Técnicos GT S.A.'
  ].join('\n');

  var linkHtml = appUrl
    ? '<p><a href="' + escapeUserInviteHtml_(appUrl) + '" style="display:inline-block;padding:12px 18px;background:#b7131a;color:#fff;text-decoration:none;border-radius:8px;font-weight:700">Abrir Gestión de Boletas</a></p>'
  ...
  var htmlBody = [
    ...
    '<div style="background:#b7131a;color:#fff;padding:18px 22px;border-radius:12px 12px 0 0"><strong>Gestión de Boletas</strong></div>',
    ...
    '<p>Se creó una cuenta para ti en Gestión de Boletas.</p>',
