const DEFAULT_TEMPLATE_ID = 'CONFIGURE_ME';
const DEFAULT_TIME_ZONE = 'America/Costa_Rica';
const MAX_EMAIL_BYTES = 18 * 1024 * 1024;

function doGet() {
  return jsonResponse_({ ok: true, service: 'gestion-boletas-mantenimientos-apps-script', time: new Date().toISOString() });
}
