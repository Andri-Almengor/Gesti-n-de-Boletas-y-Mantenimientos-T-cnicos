...
export default function AppShell() {
  ...
  return <div className={`app-shell${isWorkflowForm ? ' app-shell--form' : ''}`}>
    {!isWorkflowForm && <header className="top-bar"><button type="button" className="icon-button" onClick={() => setDrawerOpen(true)} aria-label="Abrir menú" aria-expanded={drawerOpen}><Icon name="menu" /></button><NavLink to="/" className="top-bar__brand">Gestión de Boletas</NavLink><NavLink to="/mas" className="avatar avatar--small" aria-label="Abrir perfil">{initials(user?.NombreCompleto)}</NavLink></header>}
    <OfflineSyncManager />
