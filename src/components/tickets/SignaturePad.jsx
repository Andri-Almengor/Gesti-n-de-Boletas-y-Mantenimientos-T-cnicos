...
export default function SignaturePad({ value, onChange }) {
  ...
  function publishSignature(nextValue) {
    onChange(nextValue);
    window.dispatchEvent(new CustomEvent('gt-signature-draft-change', {
  ...
  useEffect(() => {
    ...
    window.addEventListener('gt-draft-restore-signature', restore);
    return () => window.removeEventListener('gt-draft-restore-signature', restore);
  }, [onChange, value]);
