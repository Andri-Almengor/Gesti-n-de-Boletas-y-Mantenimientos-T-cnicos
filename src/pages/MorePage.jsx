...
export default function MorePage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('gt-offline-queue-change', load);
    window.addEventListener('gt-offline-sync-start', handleStart);
    window.addEventListener('gt-offline-sync-complete', handleComplete);
    window.addEventListener('gt-offline-sync-error', handleError);
    return () => {
      active = false;
      window.removeEventListener('online', handleOnline);
      window.removeEventListener('offline', handleOffline);
      window.removeEventListener('gt-offline-queue-change', load);
      window.removeEventListener('gt-offline-sync-start', handleStart);
      window.removeEventListener('gt-offline-sync-complete', handleComplete);
      window.removeEventListener('gt-offline-sync-error', handleError);
    };
  }, []);
  ...
  function forceSync() {
    ...
    window.dispatchEvent(new CustomEvent('gt-offline-sync-request', {
  ...
  return <div className="page more-page">
    ...
    <footer className="app-meta more-page__footer">Gestión de Boletas · Aplicación web instalable</footer>
  </div>;
}
