...
const DMS_LOGO_URL = 'https://example.invalid/configure-service';
  ...
  return (
    <main className="public-survey-page">
      <header className="public-survey-brand">
        ...
        <div><strong>Gestión de Boletas</strong><span>Encuesta de satisfacción</span></div>
      </header>
      ...
      <section className="public-survey-shell">
        {loading ? (
          ...
          <div className="public-survey-thanks">
            <img className="public-completion-logo" src={DMS_LOGO_URL} alt="Empresa de Servicios Técnicos" />
          ...
          <div className="public-survey-state"><Icon name="quiz" /><h1>Sin preguntas disponibles</h1><p>Comuníquese con GT para recibir asistencia.</p></div>
        )}
      </section>
      <footer className="public-survey-footer">Empresa de Servicios Técnicos · Su opinión es confidencial y se relaciona únicamente con esta boleta.</footer>
    </main>
  );
}
