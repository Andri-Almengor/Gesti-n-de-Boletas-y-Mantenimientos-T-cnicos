  ...
  return (
    <main className="public-signature-page">
      <header className="public-signature-brand">
        ...
        <div>
          <strong>Gestión de Boletas</strong>
      ...
      <footer className="public-signature-footer">Empresa de Servicios Técnicos · {testMode ? 'Prueba administrativa aislada.' : isMaintenance ? 'Enlace exclusivo para la firma general del mantenimiento.' : 'Enlace exclusivo para la firma de esta boleta.'}</footer>
    </main>
  );
}
